...
SRCS_ =  Cycles.c ReadSimCtrl.c ReadSoil.c ReadCrop.c ReadOperation.c ReadWeather.c Initialize.c Soil.c Weather.c ReferenceET.c SoilTemperature.c LinkedLists.c DebugIO.c
HEADERS_ = Cycles.h
